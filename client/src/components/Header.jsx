...
const Header = () => {
  ...
  return (
    <header className="bg-white shadow-lg sticky top-0 z-50">
      <div className="flex justify-between items-center max-w-6xl sm:mx-auto p-4 gap-6">
        <Link to="/">
        ...
        >
          ...
          <button
            type="submit"
            className="text-green-600 p-2 rounded-full hover:bg-green-100 transition-colors"
          >
            <FaSearch size={20} />
          </button>
        </form>
        ...
        <button
          className="ml-4 block sm:hidden text-green-600"
